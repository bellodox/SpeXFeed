...
- Complete relay seed registry activation after MVP shipment: wait for the submitted `sf/relays-global` record to mine, verify helper resolution, and confirm post-mining end-to-end recovery behavior for the shipped [`SpeXFeed 1.1.0-alpha.1`](../../CHANGELOG.md) release.
